...
if ( function_exists( 'wc_print_notice' )) {
	wc_print_notice( '<div class="givex-have-a-code">' . $icon . 'Got a gift card from a loved one?' . ' <a href="#" class="give-x-show-giftcard">' . 'Use it here!' . '</a> </div>', 'notice' );
}
	...
	<div style="position: relative">
		...
		<p class="form-row form-row-first">
            <p class="give-x-description">
                Apply the 20 digit gift card code in the below box
            </p>
		...
		<p class="form-row form-row-last">
			<button type="submit" id="apply_gift_card_button" class="button givex_apply_gift_card_button" name="givex_apply_gift_card" value="">
                Apply Gift Card
            </button>
		</p>
